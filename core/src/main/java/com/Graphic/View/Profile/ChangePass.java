...
import com.Graphic.Controller.Profile.ChangePassController;
...
public class ChangePass implements Screen {

    private final ChangePassController controller;
    private Stage stage;
    public Table table;
    ...
    public ChangePass(ChangePassController controller, Skin skin) {
